            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`px-2 sm:px-4 py-2 rounded-lg flex flex-col sm:flex-row items-center space-y-1 sm:space-y-0 sm:space-x-2 transition-all duration-200 ${
                    activeTab === tab.id
                ...
                >
                  ...
                  <span className="text-xs sm:text-sm sm:inline">{tab.label}</span>
                </button>
              )
            })}
          </div>
